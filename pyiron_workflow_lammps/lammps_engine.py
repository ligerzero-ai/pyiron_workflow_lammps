...
def parse_LammpsOutput(working_directory: str,
    ...
    if _parser_fn is None:
        # working_directory = _parser_fn_kwargs["working_directory"]
        # potential_elements = _parser_fn_kwargs["potential_elements"]
        # units = _parser_fn_kwargs["units"]
        # prism = _parser_fn_kwargs["prism"]
        # lammps_structure_filepath = _parser_fn_kwargs["lammps_structure_filepath"]
        # dump_out_file_name = _parser_fn_kwargs["dump_out_file_name"]
        # log_lammps_file_name = _parser_fn_kwargs["log_lammps_file_name"]
        # log_lammps_convergence_printout = _parser_fn_kwargs["log_lammps_convergence_printout"]
        try:
        ...
        print(f"working_directory: {working_directory}\n",
              f"potential_elements: {potential_elements}\n",
              f"units: {units}\n",
              f"prism: {prism}\n",
              f"lammps_structure_filepath: {lammps_structure_filepath}\n",
              f"dump_out_file_name: {dump_out_file_name}\n",
              f"log_lammps_file_name: {log_lammps_file_name}\n",
              f"log_lammps_convergence_printout: {log_lammps_convergence_printout}\n")
